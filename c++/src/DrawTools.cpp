...
void DrawTools::DrawUnitCommands()
{
...
void DrawTools::DrawUnitBoundingBoxes()
{
...
void DrawTools::DrawUnitHealthBars()
{
...
void DrawTools::DrawHealthBar(BWAPI::Unit unit, double ratio, BWAPI::Color color, int yOffset)
{
    int verticalOffset = -10;
    const BWAPI::Position& pos = unit->getPosition();
